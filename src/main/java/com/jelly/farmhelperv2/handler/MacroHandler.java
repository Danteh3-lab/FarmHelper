...
public class MacroHandler {
    ...
    public <T extends AbstractMacro> T getMacro() {
        switch (FarmHelperConfig.getMacro()) {
            ...
            case GLACITE_WALKER_COMBAT:
                return Macros.GLACITE_WALKER_MACRO.getMacro();
            default:
    ...
    public void enableMacro() {
        // Combat macros don't require garden location
        boolean isCombatMacro = FarmHelperConfig.getMacro() == FarmHelperConfig.MacroEnum.GLACITE_WALKER_COMBAT;
        
        if (!isCombatMacro && !GameStateHandler.getInstance().inGarden()) {
...
//            Scheduler.getInstance().resume(); - gets enabled in featuremanager
    ...
    public enum Macros {
        ...
        GLACITE_WALKER_MACRO(com.jelly.farmhelperv2.macro.impl.GlaciteWalkerMacro.class);
